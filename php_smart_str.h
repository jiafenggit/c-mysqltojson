...
#define SMART_STR_PREALLOC (size_t) 128
#endif

#ifndef SMART_STR_START_SIZE
#define SMART_STR_START_SIZE (size_t) 78
#endif
...
extern void smart_str_free(/*@special@*/ /*@only@*/ /*@notnull@*/ smart_str* s) /*@releases s->c@*/;
#define smart_str_free(s) \
	smart_str_free_ex((s), 0)

extern void smart_str_appendl(/*@out@*/ /*@notnull@*/ smart_str* dest, /*@notnull@*/ smart_str* src, size_t len);
...
extern void smart_str_free_ex(/*@special@*/ /*@notnull@*/ /*@only@*/ smart_str* s) /*@releases s->c@*/;
// pefree -> free, pefree(__s-c, what)
